...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: Cortex-A7[ca7] */
  /* IOMUXC_ENET1_MAC0_MDIO_SELECT_INPUT register modification value */
  IOMUXC_BASE_PTR->SELECT_INPUT[48U] = IOMUXC_SELECT_INPUT_DAISY(1U);
  /* IOMUXC_ENET1_REF_CLK1_SELECT_INPUT register modification value */
  IOMUXC_BASE_PTR->SELECT_INPUT[47U] = IOMUXC_SELECT_INPUT_DAISY(2U);
  /* IOMUXC_SW_MUX_CTL_PAD_ENET1_RX_DATA0 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[32U] = 0U;
  /* IOMUXC_SW_MUX_CTL_PAD_ENET1_RX_DATA1 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[33U] = 0U;
  /* IOMUXC_SW_MUX_CTL_PAD_ENET1_RX_ER register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[39U] = 0U;
  /* IOMUXC_SW_MUX_CTL_PAD_ENET1_TX_CLK register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[38U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(4U);
  /* IOMUXC_SW_MUX_CTL_PAD_ENET1_TX_DATA0 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[35U] = 0U;
  /* IOMUXC_SW_MUX_CTL_PAD_ENET1_TX_DATA1 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[36U] = 0U;
  /* IOMUXC_SW_MUX_CTL_PAD_ENET1_TX_EN register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[37U] = 0U;
  /* IOMUXC_SW_MUX_CTL_PAD_ENET2_RX_DATA0 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[40U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(4U);
  /* IOMUXC_SW_MUX_CTL_PAD_ENET2_RX_DATA1 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[41U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(4U);
  /* IOMUXC_SW_MUX_CTL_PAD_ENET2_RX_EN register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[42U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(8U);
  /* IOMUXC_SW_MUX_CTL_PAD_ENET2_TX_DATA0 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[43U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(5U);
  /* IOMUXC_SW_MUX_CTL_PAD_NAND_DATA00 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[79U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(1U);
  /* IOMUXC_SW_MUX_CTL_PAD_NAND_DATA01 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[80U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(1U);
  /* IOMUXC_SW_MUX_CTL_PAD_NAND_DATA02 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[81U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(1U);
  /* IOMUXC_SW_MUX_CTL_PAD_NAND_DATA03 register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[82U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(1U);
  /* IOMUXC_SW_MUX_CTL_PAD_NAND_READY_B register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[89U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(5U);
  /* IOMUXC_SW_MUX_CTL_PAD_NAND_RE_B register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[77U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(1U);
  /* IOMUXC_SW_MUX_CTL_PAD_NAND_WE_B register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[78U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(1U);
  ...
  /* IOMUXC_SW_MUX_CTL_PAD_UART1_CTS_B register modification value */
  IOMUXC_BASE_PTR->SW_MUX_CTL_PAD[18U] = IOMUXC_SW_MUX_CTL_PAD_MUX_MODE(1U);
  /* IOMUXC_USDHC2_CLK_SELECT_INPUT register modification value */
  IOMUXC_BASE_PTR->SELECT_INPUT[110U] = IOMUXC_SELECT_INPUT_DAISY(2U);
  /* IOMUXC_USDHC2_CMD_SELECT_INPUT register modification value */
  IOMUXC_BASE_PTR->SELECT_INPUT[112U] = IOMUXC_SELECT_INPUT_DAISY(2U);
  /* IOMUXC_USDHC2_DATA0_SELECT_INPUT register modification value */
  IOMUXC_BASE_PTR->SELECT_INPUT[113U] = IOMUXC_SELECT_INPUT_DAISY(2U);
  /* IOMUXC_USDHC2_DATA1_SELECT_INPUT register modification value */
  IOMUXC_BASE_PTR->SELECT_INPUT[114U] = IOMUXC_SELECT_INPUT_DAISY(2U);
  /* IOMUXC_USDHC2_DATA2_SELECT_INPUT register modification value */
  IOMUXC_BASE_PTR->SELECT_INPUT[115U] = IOMUXC_SELECT_INPUT_DAISY(1U);
  /* IOMUXC_USDHC2_DATA3_SELECT_INPUT register modification value */
  IOMUXC_BASE_PTR->SELECT_INPUT[116U] = IOMUXC_SELECT_INPUT_DAISY(2U);
}
