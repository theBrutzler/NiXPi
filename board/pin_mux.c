...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: Cortex-A7[ca7] */
    ...
    IOMUXC_SetPinMux(IOMUXC_ENET1_TX_CLK_ENET1_REF_CLK1, 0U);
    ...
    IOMUXC_SetPinMux(IOMUXC_ENET2_RX_DATA0_ENET1_MDIO, 0U);
    IOMUXC_SetPinMux(IOMUXC_ENET2_RX_DATA1_ENET1_MDC, 0U);
    IOMUXC_SetPinMux(IOMUXC_ENET2_RX_EN_ENET1_REF_CLK_25M, 0U);
    IOMUXC_SetPinMux(IOMUXC_ENET2_TX_DATA0_GPIO2_IO11, 0U);
    ...
    IOMUXC_SetPinMux(IOMUXC_NAND_READY_B_GPIO4_IO12, 0U);
    ...
    IOMUXC_SetPinMux(IOMUXC_UART1_CTS_B_ENET1_RX_CLK, 0U);
}
